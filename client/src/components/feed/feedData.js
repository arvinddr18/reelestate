export const SAMPLE_FEED_DATA = [
  ...
  {
    id: '2', type: 'MARKETPLACE', size: 'large',
  ...
  {
    id: '4', type: 'REAL_ESTATE', size: 'tall',
  ...
  {
    id: '5', type: 'SOCIAL', size: 'small',
    user: { name: 'Chai & Code', handle: 'code.with.chai', avatar: 'https://i.pravatar.cc/150?img=3' },
    post: { title: 'Coffee + Code', description: '+ Lo-fi Beats = Perfect Evening ☕🎧', time: '2h ago', stats: { likes: 96, comments: 18 } }
  },
  {
    id: '6', type: 'MARKETPLACE', size: 'small',
    user: { name: 'SneakerHead', handle: 'kicks', avatar: 'https://i.pravatar.cc/150?img=4' },
    product: { title: 'Nike Air Force 1 \'07 White', price: '₹8,499', isLive: true, media: 'https://images.unsplash.com/photo-1595950653106-6c9ebd614d3a?q=80&w=400&auto=format&fit=crop' }
  },
  {
    id: '7', type: 'SERVICES', size: 'small',
    ...
    service: { title: 'Need a UI/UX Designer?', description: 'I can help!', rate: '₹2,500 / hr', isLive: false }
  },
  {
    id: '8', type: 'EVENTS', size: 'small',
