      ...
      <div className="w-full max-w-[440px] relative z-10 group">
        ...
        <div className="relative bg-[#0B0F19]/80 backdrop-blur-3xl border border-white/5 p-8 rounded-[40px] shadow-[0_20px_50px_rgba(0,0,0,0.5)]">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {/* Split Grid for Name and Username */}
              ...
              <div className="space-y-1">
                ...
                <div className="relative">
                  ...
                  <input 
                    ...
                    className="w-full bg-[#05070A]/50 border border-[#1E2532] rounded-2xl py-3 pl-10 pr-3 text-xs font-bold outline-none focus:border-[#00F0FF]/40 transition-all"
            ...
            <button type="submit" className="w-full py-4 mt-4 bg-gradient-to-r from-[#0057FF] to-[#00F0FF] text-white font-black uppercase tracking-[0.2em] text-xs rounded-2xl hover:scale-[1.02] hover:shadow-[0_0_20px_rgba(0,240,255,0.4)] transition-all active:scale-95 flex items-center justify-center gap-2">
              Launch Node <IoMdRocket size={18} />
            </button>
          </form>
