...
import { 
  FiSearch, FiHome, FiCompass, FiPlus, FiMail, FiUser, FiZap 
} from 'react-icons/fi';
  ...
  return (
    <div className="h-[100dvh] w-full bg-[#FAFAFA] flex flex-col overflow-hidden font-sans text-black">
      ...
      <div className="flex-1 overflow-y-auto no-scrollbar pb-32">
        ...
        {/* ─── TRENDING CAROUSEL (Unchanged - Perfect) ─── */}
        ...
        {/* ─── FOR YOU: OVERLAPPING COLLAGE FEED ─── */}
                ...
                <div key={index} className="relative w-full h-[280px]">
                  ...
                  {post2 && (
                    ...
                    >
                      ...
                      {/* Icons for Back Card (Mockup Match: Plain white heart) */}
                  ...
                  {/* 👇 THE FRONT CARD (Left Side, Overlaps Right Card) 👇 */}
                  {post1 && (
                    <motion.div
                      whileTap={{ scale: 0.98 }}
                      onClick={() => navigate(`/posts/${post1._id}`)}
                      // Width is 55%, creating a seamless overlap over the right card!
                    ...
                    >
                      ...
                      {/* Icons for Front Card (Mockup Match: Pink Circle with White Heart) */}
                      <div className="absolute right-3 bottom-4 flex flex-col items-center gap-3 z-20">
