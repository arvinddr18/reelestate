      ...
      <div className="w-full max-w-[400px] bg-white h-[100dvh] relative overflow-hidden flex flex-col shadow-2xl sm:rounded-3xl sm:h-[850px] sm:my-8 border border-gray-200">
        ...
        <div className="flex-1 overflow-y-auto pb-24 [&::-webkit-scrollbar]:hidden">
          ...
          <div className="px-5 pt-12 pb-4">
            ...
            {/* Category Filter */}
            <div className="flex gap-2 mt-5 overflow-x-auto [&::-webkit-scrollbar]:hidden">
          ...
          {/* Trending Cards Section (Horizontal Scroll) */}
          <div className="flex gap-4 px-5 overflow-x-auto snap-x snap-mandatory [&::-webkit-scrollbar]:hidden pb-4">
            
            {/* Featured Card #1 */}
            <div className="min-w-[260px] h-[360px] rounded-[24px] relative overflow-hidden snap-center flex-shrink-0 shadow-[0_0_20px_rgba(59,130,246,0.3)] border border-blue-400/20">
              <img 
              ...
              <div className="absolute top-4 left-4 right-4 flex justify-between items-start">
                <span className="text-white text-4xl font-black drop-shadow-md">#1</span>
              ...
              <div className="absolute bottom-4 left-4 text-white font-medium flex items-center gap-1.5">
            ...
            {/* Secondary Card #2 */}
            <div className="min-w-[160px] h-[220px] rounded-[20px] relative overflow-hidden snap-center flex-shrink-0 mt-auto shadow-md">
              <img 
          ...
          <div className="px-5 mt-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              {/* Grid Item 1 */}
              <div className="rounded-[20px] h-[260px] relative overflow-hidden shadow-sm">
                <img 
                ...
                <div className="absolute bottom-3 right-3 flex flex-col gap-3">
                  <div className="flex flex-col items-center">
                    ...
                    <span className="text-white text-xs font-semibold drop-shadow">16.2K</span>
                  </div>
                  <div className="flex flex-col items-center">
                    <div className="w-8 h-8 rounded-full bg-white/20 backdrop-blur-sm flex items-center justify-center mb-1">
              ...
              <div className="rounded-[20px] h-[260px] relative overflow-hidden shadow-sm">
                ...
                <div className="absolute bottom-3 right-3 flex flex-col gap-3">
                  <div className="flex flex-col items-center">
                    ...
                    <span className="text-white text-xs font-semibold drop-shadow">231</span>
                  </div>
                  <div className="flex flex-col items-center">
                    <div className="w-8 h-8 rounded-full bg-white/20 backdrop-blur-sm flex items-center justify-center mb-1">
                      <span className="text-white text-sm">💬</span>
